...
// Mock translation data with tone variations
const mockTranslationsWithTone: Record<string, Record<string, Record<string, string>>> = {
  "ja-ko": {
    "casual": {
      "こんにちは": "안녕!",
      "ありがとう": "고마워",
    ...
    "neutral": {
      ...
      "ありがとう": "고맙습니다",
      "おはようございます": "좋은 아침입니다",
      "今日は良い天気ですね": "오늘 날씨가 좋네요",
    },
    "semi-formal": {
      "こんにちは": "안녕하십니다",
      "ありがとう": "감사합니다",
      "おはようございます": "좋은 아침입니다",
      "今日は良い天気ですね": "오늘은 날���가 좋습니다",
    },
    "formal": {
      "こんにちは": "안녕하십니까",
      "ありがとう": "감사드립니다",
      "おはようございます": "좋은 아침이십니다",
      "今日は良い天気ですね": "오늘은 날씨가 매우 좋습니다",
    },
  },
  "ja-en-us": {
    "casual": {
    ...
    "semi-formal": {
      ...
      "おはようございます": "Good morning",
      "今日は良い天気ですね": "The weather is quite nice today",
    },
    "formal": {
      "こんにちは": "Good day to you",
      "ありがとう": "I thank you most sincerely",
      "おはようございます": "I wish you a good morning",
      "今日は良い天気ですね": "The weather is exceptionally pleasant today",
    },
  },
};

// Legacy mock translations for backward compatibility
const mockTranslations: Record<string, Record<string, string>> = {
  ...
  "ja-en-uk": {
    ...
    "ありがとう": "Thank you",
    "おはようございます": "Good morning",
    "今日は良い天気ですね": "It's lovely weather today",
  },
  "ja-en-au": {
    "こんにちは": "G'day",
    "ありがとう": "Thanks",
    "おはようございます": "Good morning",
    "今日は良い天気ですね": "Beautiful day today",
  },
  "ko-ja": {
    "안녕하세요": "こんにちは",
    "감사합니다": "ありがとう",
    "좋은 아침입니다": "おはようございます",
    "오늘은 날씨가 좋네요": "今日は良い天気ですね",
  },
  "ko-en-us": {
    "안녕하세요": "Hello",
    "감사합니다": "Thank you",
    "좋은 아침입니다": "Good morning",
    "오늘은 날씨가 좋네요": "It's nice weather today",
  },
  "ko-en-uk": {
    "안녕하세요": "Hello",
    "감사합니다": "Thank you",
    "좋은 아침입니다": "Good morning",
    "오늘은 날씨가 좋네요": "It's lovely weather today",
  },
  "ko-en-au": {
    "안녕하세요": "G'day",
    "감사합니다": "Thanks",
    "좋은 아침입니다": "Good morning",
    "오늘은 날씨가 좋네요": "Beautiful day today",
  },
  "en-us-ja": {
    "Hello": "こんにちは",
    "Thank you": "ありがとう",
  ...
  "en-us-ko": {
    ...
    "It's nice weather today": "오늘은 날씨가 좋네요",
  },
  "en-uk-ja": {
    "Hello": "こんにちは",
    "Thank you": "ありがとう",
    "Good morning": "おはようございます",
    "It's lovely weather today": "今日は良い天気ですね",
  },
  "en-uk-ko": {
    "Hello": "안녕하세요",
    "Thank you": "감사합니다",
    "Good morning": "좋�� 아침입니다",
    "It's lovely weather today": "오늘은 날씨가 좋네요",
  },
  "en-au-ja": {
    "G'day": "こんにちは",
    "Thanks": "ありがとう",
    "Good morning": "おはようございます",
    "Beautiful day today": "今日は良い天気ですね",
  },
  "en-au-ko": {
    "G'day": "안녕하세요",
    "Thanks": "감사합니다",
    "Good morning": "좋은 아침입니다",
    "Beautiful day today": "오늘은 날씨가 좋네요",
  },
  // Cross-English translations
  "en-us-en-uk": {
    "Hello": "Hello",
    "Thank you": "Thank you",
    "Good morning": "Good morning",
    "It's nice weather today": "It's lovely weather today",
  },
  "en-us-en-au": {
    "Hello": "G'day",
    "Thank you": "Thanks",
    "Good morning": "Good morning",
    "It's nice weather today": "Beautiful day today",
  },
  "en-uk-en-us": {
    "Hello": "Hello",
    "Thank you": "Thank you",
    "Good morning": "Good morning",
    "It's lovely weather today": "It's nice weather today",
  },
  "en-uk-en-au": {
    "Hello": "G'day",
    "Thank you": "Thanks",
    "Good morning": "Good morning",
    "It's lovely weather today": "Beautiful day today",
  },
  "en-au-en-us": {
    "G'day": "Hello",
    "Thanks": "Thank you",
    "Good morning": "Good morning",
    "Beautiful day today": "It's nice weather today",
  },
  "en-au-en-uk": {
    "G'day": "Hello",
    "Thanks": "Thank you",
    "Good morning": "Good morning",
    "Beautiful day today": "It's lovely weather today",
  },
};
